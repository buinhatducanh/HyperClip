                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    Layout.fillWidth: true
                                    height: 18
                                    color: (poller.lastDetectionLatencyStr || "—").includes("s") ?
                                        (parseInt((poller.lastDetectionLatencyStr || "0").replace("s","")) < 5 ? Theme.success : Theme.error)
                                        : Theme.textMuted
                                    opacity: 0.2
                                    radius: 3
                                    Label {
                                ...
                                Rectangle {
                                    Layout.fillWidth: true
                                    height: 18
                                    color: (poller.slaPercent || 0) > 90 ? Theme.success : (poller.slaPercent || 0) > 70 ? "#FFD93D" : Theme.error
                                    opacity: 0.2
                                    radius: 3
                                    Label {
                                        anchors.centerIn: parent
                                        text: (poller.slaPercent || 0).toFixed(0) + "% <5s"
                                        font.pixelSize: 11; font.bold: true
                                    }
                                }
                                Rectangle {
                                    ...
                                    Label {
                                        anchors.centerIn: parent
                                        text: (poller.detectionsToday || 0) + " hôm nay"
                                        font.pixelSize: 11; font.bold: true
                                    }
                                }
                            }
