    ...
    <div style={{ maxWidth: 560 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `${colors.success}22`, border: `2px solid ${colors.success}`,
        ...
        <div style={{ fontSize: 13, color: colors.textSecondary, textAlign: 'center', lineHeight: 1.6 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 28 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: readySessions > 0 ? colors.success : colors.textSecondary, marginBottom: 4 }}>
            {readySessions}/{sessionTotal}
          </div>
          <div style={{ fontSize: 10, color: colors.textSecondary }}>Chrome Sessions</div>
          <div style={{ fontSize: 9, color: colors.textSecondary, marginTop: 4 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: channels.length > 0 ? colors.accent : colors.textSecondary, marginBottom: 4 }}>
            {channels.length}
          </div>
          <div style={{ fontSize: 10, color: colors.textSecondary }}>Channels</div>
          <div style={{ fontSize: 9, color: colors.textSecondary, marginTop: 4 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: projectCount > 0 ? colors.success : colors.textSecondary, marginBottom: 4 }}>
            {projectCount}
          </div>
          <div style={{ fontSize: 10, color: colors.textSecondary }}>GCP Projects</div>
          <div style={{ fontSize: 9, color: colors.textSecondary, marginTop: 4 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ width: 4, height: 4, borderRadius: '50%', background: colors.textSecondary, flexShrink: 0 }} />
              {tip}
            </div>
          ))}
        </div>
      ...
      <div style={{ display: 'flex', gap: 10, justifyContent: 'space-between' }}>
        ...
        <button
          ...
          style={{
            ...
            background: isLaunching ? colors.accentHover : colors.success,
            border: 'none',
            borderRadius: 8, fontSize: 12, fontWeight: 700,
            color: colors.text, cursor: isLaunching ? 'not-allowed' : 'pointer',
          }}
        >
