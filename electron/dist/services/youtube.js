...
function simulateDownloadProgress(workspaceId, onProgress, durationSec, quality, trimLimitSec) {
...
async function multiInstanceDownload(opts) {
...
export async function downloadVideo(opts) {
    ...
    const doDownload = (extraArgs) => {
        ...
        args.push('-f', resolvedFormat, '--output', outputTemplate, '--no-playlist', '--newline', '--concurrent-fragments', '32', '--retries', '3', '--fragment-retries', '3', '--socket-timeout', '10', '--http-chunk-size', '10485760', ...extraArgs);
